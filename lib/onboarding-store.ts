    ...
    (set, get) => ({
      ...
      steps: [
        {
          ...
          description: 'Let\'s take a personalized tour to help you master our 3D customization platform. This will take about 5-10 minutes.',
          position: 'center',
          autoAdvance: true,
          delay: 3000,
          category: 'basic',
          estimatedTime: 10,
          tips: ['You can pause anytime by pressing Space', 'Use arrow keys to navigate', 'Click the dots below to jump to any step'],
          shortcuts: [
        ...
        },
        {
          ...
          description: 'Your command center! This sidebar contains all the essential tools and sections. Pro tip: You can collapse it for more workspace.',
          target: '[data-tour="sidebar"]',
          position: 'right',
          category: 'basic',
          estimatedTime: 15,
          tips: ['Use Ctrl+B to toggle sidebar quickly', 'Sections are organized by workflow'],
          userTypes: ['beginner', 'designer', 'business'],
        },
        {
          id: 'model-loader',
          title: '🎽 3D Model Gallery',
          description: 'Start your creativity here! Browse our extensive collection of 3D models including apparel, accessories, and sports equipment.',
          target: '[data-tour="model-loader"]',
          position: 'right',
          category: 'basic',
          estimatedTime: 20,
          tips: ['Models are categorized by type', 'Use search to find specific items quickly', 'Preview models before loading'],
          action: () => {
            // Expand model section if collapsed
            const modelSection = document.querySelector('[data-tour="model-loader"]');
            if (modelSection) {
        ...
        },
        {
          ...
          description: 'Transform your model with materials! Customize colors, textures, and finishes for each part of your 3D model.',
        ...
        },
        {
          ...
          description: 'Unleash AI creativity! Generate unlimited unique textures by describing what you envision. Perfect for one-of-a-kind designs.',
        ...
        },
        {
          ...
          description: 'The interface adapts to different screen sizes. Try resizing your browser window!',
          position: 'center',
          autoAdvance: true,
          delay: 1500,
        },
        ...
        },
        {
          ...
          description: 'Congratulations! You\'ve mastered the essentials of Besu Customs. Time to bring your creative visions to life. Remember: save early, save often!',
          position: 'center',
          autoAdvance: true,
          delay: 4000,
          category: 'basic',
      ...
      startOnboarding: (userType?: UserType) => {
        ...
        set({ 
          ...
          stepStartTime: now,
          isPaused: false,
          preferences: userType ? { ...state.preferences, userType } : state.preferences,
          analytics: {
            ...state.analytics,
      ...
      getFilteredSteps: () => {
        ...
        return steps.filter(step => {
          ...
          if (step.userTypes && !step.userTypes.includes(preferences.userType)) {
            return false;
          }
          return true;
        });
      ...
      getEstimatedTimeRemaining: () => {
        ...
        return remainingSteps.reduce((total, step) => total + (step.estimatedTime || 30), 0);
      },
    }),
    {
