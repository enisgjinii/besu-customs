    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Link products to 3D model URLs</p>
        </div>

        <div className="bg-card border-2 border-primary">
          <div className="p-4 border-b-2 border-primary">
            <h2 className="text-lg font-bold text-foreground">Product Models</h2>
          </div>
              ...
              <div key={product.id} className="p-4">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    {product.modelUrl && <p className="text-xs text-accent mt-2 break-all">{product.modelUrl}</p>}
                  </div>
