    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Recent application logs. For complete logs, check Vercel Dashboard
            or use the Vercel Toolbar.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              No logs found. Logs are stored in Vercel and may not be available
              in this view.
              <br />
              <span className="text-sm">
                Use Vercel Dashboard or add ?vercelToolbar=1 to your URL to view
                logs.
              </span>
            </div>
          ) : (
