...
export default function UserActivityPage() {
  ...
  const topUsers = [
    { id: 'user1', name: 'John Doe', activityCount: 42, lastActive: '5 minutes ago' },
    { id: 'user2', name: 'Jane Smith', activityCount: 38, lastActive: '15 minutes ago' },
    { id: 'user3', name: 'Alex Johnson', activityCount: 29, lastActive: '1 hour ago' },
    { id: 'user4', name: 'Sarah Wilson', activityCount: 21, lastActive: '3 hours ago' },
    { id: 'user5', name: 'Mike Brown', activityCount: 18, lastActive: '5 hours ago' },
  ];
            ...
            <Card key={stat.name}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <div className="h-4 w-4 text-muted-foreground">
                  {stat.name.includes('Logins') && <Users className="h-4 w-4" />}
                  {stat.name.includes('Active') && <Activity className="h-4 w-4" />}
                  {stat.name.includes('Page') && <BarChart3 className="h-4 w-4" />}
                  {stat.name.includes('Session') && <Clock className="h-4 w-4" />}
                </div>
              </CardHeader>
              <CardContent>
