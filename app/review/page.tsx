...
const DEMO_MODEL_URL = "https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/DamagedHelmet.glb"
    ...
    <div className="h-screen flex flex-col md:flex-row">
      ...
      <aside className="w-full md:w-80 h-64 md:h-full border-t-2 md:border-t-0 md:border-l-2 border-primary bg-card overflow-y-auto">
        <div className="p-4 border-b-2 border-primary">
          ...
          <p className="text-xs text-muted-foreground mt-1">Damaged Helmet model loaded</p>
        </div>
        <div className="p-4">
          <MaterialEditor />
        </div>
