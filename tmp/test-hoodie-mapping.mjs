...
const sections = [
  ...
  },
  {
    id: "e",
    name: "Zipper Teeth",
    originalName: "zipper_teeth",
    category: "Other",
    color: "#000000",
  },
  {
    id: "e2",
    name: "Zipper Tape Fabric",
    originalName: "zipper tape fabric",
    category: "Other",
    color: "#000000",
  },
  {
  ...
  },
  {
    id: "i",
    name: "Zipper Puller",
    originalName: "zipper puller",
    category: "Other",
    color: "#000000",
  },
  {
    id: "j",
    name: "Zipper TopStopper",
    originalName: "zipper top stopper 1",
    category: "Other",
    color: "#000000",
  },
  {
    id: "k",
    name: "Zipper TopStopper",
    originalName: "zipper top stopper 2",
    category: "Other",
    color: "#000000",
  },
  {
    id: "l",
    name: "Zipper BottomStopper",
    originalName: "zipper bottom stopper 1",
    category: "Other",
    color: "#000000",
  },
  {
    id: "m",
    name: "Zipper BottomStopper",
    originalName: "zipper bottom stopper 2",
    category: "Other",
    color: "#000000",
  },
];

const result = applyBasketballJerseyNaming(
  sections,
  "basketball shooting shirt with hoodie.glb",
);
console.log(
  JSON.stringify(
    result.map((s) => ({
