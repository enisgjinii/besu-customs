...
const glbPath = '/Users/enisgjini/Desktop/besu-customs/public/models/basketball shooting shirt short sleeve with hoodie.glb';
...
try {
  ...
  const uniqueWords = [...new Set(words)].filter(w => 
    w.length > 2 && 
    (w.includes('Zipper') || w.includes('Cord') || w.includes('Fabric') || w === 'X')
  );
