...
// --- PRESET DATA ---
const STYLE_PRESETS = [
    { id: "style-1", name: "Classic Varsity", description: "Timeless athletic", colors: { "Body": "#1e3a8a", "Sleeves": "#f3f4f6", "Cuffs": "#1e3a8a" }, patternId: null },
    { id: "style-2", name: "Midnight Stealth", description: "All black", colors: { "Body": "#111111", "Sleeves": "#222222", "Cuffs": "#000000" }, patternId: "carbon-fiber" },
    { id: "style-3", name: "Retro 90s", description: "Bold geometric", colors: { "Body": "#f59e0b", "Sleeves": "#3b82f6", "Cuffs": "#ec4899" }, patternId: "abstract-geo" },
    { id: "style-4", name: "Forest Ranger", description: "Earthy tones", colors: { "Body": "#166534", "Sleeves": "#14532d", "Cuffs": "#fca5a5" }, patternId: "camo-woodland" },
    { id: "style-5", name: "Urban Concrete", description: "Street style", colors: { "Body": "#9ca3af", "Sleeves": "#4b5563", "Cuffs": "#1f2937" }, patternId: "concrete-texture" },
    { id: "style-6", name: "Crimson Tide", description: "Aggressive red", colors: { "Body": "#dc2626", "Sleeves": "#991b1b", "Cuffs": "#ffffff" }, patternId: "flames" },
    { id: "style-7", name: "Golden State", description: "Royal Gold", colors: { "Body": "#1d4ed8", "Sleeves": "#1d4ed8", "Cuffs": "#fbbf24" }, patternId: null },
    { id: "style-8", name: "Arctic Freeze", description: "Cool gradients", colors: { "Body": "#e0f2fe", "Sleeves": "#bae6fd", "Cuffs": "#0ea5e9" }, patternId: "ice-shards" },
    { id: "style-9", name: "Neon Cyber", description: "Futuristic glow", colors: { "Body": "#2e1065", "Sleeves": "#c026d3", "Cuffs": "#22d3ee" }, patternId: "circuit-board" },
    { id: "style-10", name: "Minimalist Luxe", description: "Clean premium", colors: { "Body": "#f8fafc", "Sleeves": "#f1f5f9", "Cuffs": "#64748b" }, patternId: "subtle-weave" },
];

// Simple SVG Preview Component
function StylePreviewIcon({ colors, hasPattern }: { colors: Record<string, string>, hasPattern: boolean }) {
    ...
    return (
        <div className="w-full h-full flex items-center justify-center bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-3 pointer-events-none">
            <svg viewBox="0 0 100 100" className="w-full h-full drop-shadow-md" preserveAspectRatio="xMidYMid meet">
                <defs>
                    {hasPattern && (
                        <pattern id={`pattern-${bodyColor.replace('#', '')}`} x="0" y="0" width="8" height="8" patternUnits="userSpaceOnUse">
                ...
                {/* T-Shirt Body */}
                <path d="M25 25 L75 25 L85 40 L70 50 L70 90 L30 90 L30 50 L15 40 Z" fill={bodyColor} />
                {hasPattern && <path d="M25 25 L75 25 L85 40 L70 50 L70 90 L30 90 L30 50 L15 40 Z" fill={`url(#pattern-${bodyColor.replace('#', '')})`} />}
                ...
                {/* Collar */}
                <path d="M40 25 Q50 35 60 25" stroke={cuffColor} strokeWidth="4" fill="none" strokeLinecap="round" />

                {/* Cuff accents */}
                <rect x="28" y="85" width="44" height="5" rx="2" fill={cuffColor} />

                {/* Outline */}
                <path d="M25 25 L75 25 L85 40 L70 50 L70 90 L30 90 L30 50 L15 40 Z" fill="none" stroke="rgba(0,0,0,0.15)" strokeWidth="1" />
            </svg>
        </div>
    );
}
...
export function Step03Style() {
    ...
    const handleApplyStyle = (preset: typeof STYLE_PRESETS[0]) => {
        ...
        if (preset.patternId) {
            ...
            addTextureLayer({
                id: patternId, name: preset.name + " Pattern", type: 'pattern',
                visible: true, locked: false, opacity: 0.8, blendMode: 'multiply', order: 0,
                imageUrl: patternUrl, position: [0.5, 0.5, 0], rotation: [0, 0, 0], scale: [1, 1, 1]
            });
        }
    };
