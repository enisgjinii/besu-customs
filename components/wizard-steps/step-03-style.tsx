...
const STYLE_PRESETS = [
  { id: "style-1", name: "Classic Varsity", colors: { Body: "#1e3a8a", Sleeves: "#f3f4f6", Cuffs: "#1e3a8a" } },
  { id: "style-2", name: "Midnight", colors: { Body: "#111111", Sleeves: "#222222", Cuffs: "#000000" } },
  { id: "style-3", name: "Retro 90s", colors: { Body: "#f59e0b", Sleeves: "#3b82f6", Cuffs: "#ec4899" } },
  { id: "style-4", name: "Forest", colors: { Body: "#166534", Sleeves: "#14532d", Cuffs: "#fca5a5" } },
  { id: "style-5", name: "Urban", colors: { Body: "#9ca3af", Sleeves: "#4b5563", Cuffs: "#1f2937" } },
  { id: "style-6", name: "Crimson", colors: { Body: "#dc2626", Sleeves: "#991b1b", Cuffs: "#ffffff" } },
  { id: "style-7", name: "Golden", colors: { Body: "#1d4ed8", Sleeves: "#1d4ed8", Cuffs: "#fbbf24" } },
  { id: "style-8", name: "Arctic", colors: { Body: "#e0f2fe", Sleeves: "#bae6fd", Cuffs: "#0ea5e9" } },
];
  ...
  return (
    <div className="space-y-2">
      <div>
        ...
        <p className="text-xs text-muted-foreground">Apply preset color schemes</p>
      </div>
      ...
      <div className="grid grid-cols-4 gap-2">
        {STYLE_PRESETS.map((preset) => (
          ...
          >
            ...
            <span className="text-[9px] font-medium text-center leading-tight">{preset.name}</span>
            {selectedStyle === preset.id && (
