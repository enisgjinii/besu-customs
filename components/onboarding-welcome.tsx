          ...
          <>
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground text-sm">
                  Ready to master 3D customization? Let's create a personalized tour for you.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 flex-col sm:flex-row">
                <Button variant="outline" onClick={handleSkip} className="flex-1 text-sm">
                  Later
                </Button>
                <Button variant="outline" onClick={handleSkip} className="flex-1 text-sm">
        ...
        {step === 'userType' && (
          <>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 space-y-1 min-w-0">
                        <div className="flex items-center justify-between">
                          <h3 className="font-medium truncate">{userType.title}</h3>
                        ...
                        <div className="flex flex-wrap gap-1 mt-2">
                          {userType.features.map((feature, index) => (
                            <span key={index} className="text-xs bg-secondary/50 px-2 py-1 rounded whitespace-nowrap">
                              {feature}
                            </span>
                          ))}
                        </div>
            ...
            <div className="flex gap-3">
              <Button variant="outline" onClick={() => setStep('welcome')} className="flex-1 text-sm">
                Back
              </Button>
            </div>
          </>
          ...
          <>
                      ...
                      <>
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">{selectedType.estimatedTime}</p>
                          </div>
                        </div>
                      </>
                    );
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <Button variant="outline" onClick={handleBackToUserType} className="flex-1 text-sm">
                  Change
                </Button>
                <Button variant="outline" onClick={handleSkip} className="flex-1 text-sm">
                  Skip
