...
export function GoogleLogo({ size = 20, className = "", variant = "default" }: GoogleLogoProps) {
    ...
    return (
      ...
      >
        <svg
          ...
          focusable="false"
        >
          <path fill="#EA4335" d="M12 11.99v4.8h6.69c-.27 1.57-1.87 4.6-6.69 4.6-4.03 0-7.31-3.33-7.31-7.42S7.97 6.55 12 6.55c2.29 0 3.83.97 4.71 1.8l3.3-3.24C18.64 3.55 15.82 2.2 12 2.2 5.73 2.2.6 7.35.6 13.62c0 6.27 5.13 11.42 11.4 11.42 6.58 0 10.93-4.62 10.93-11.13 0-.75-.08-1.32-.18-1.92H12Z" />
          <path fill="#34A853" d="M3.15 7.15A11.37 11.37 0 0 1 12 2.2c3.82 0 6.64 1.35 8.01 2.91l-3.32 3.24c-.88-.83-2.42-1.8-4.7-1.8-4.03 0-7.31 3.33-7.31 7.42 0 1.83.69 3.49 1.82 4.74L3.15 7.15Z" />
          <path fill="#FBBC05" d="M12 25.04c4.82 0 6.42-3.03 6.69-4.6H12v-4.8h11.15c.1.6.18 1.17.18 1.92 0 6.51-4.35 11.13-10.93 11.13-6.27 0-11.4-5.15-11.4-11.42 0-1.97.49-3.83 1.36-5.47l3.35 9.58c-1.13-1.25-1.82-2.9-1.82-4.73 0 4.09 3.28 7.42 7.31 7.42Z" />
          <path fill="#4285F4" d="M23.15 11.19H12v4.8h6.69c-.32 1.87-2.11 4.6-6.69 4.6-4.03 0-7.31-3.33-7.31-7.42S7.97 6.55 12 6.55c2.29 0 3.83.97 4.71 1.8l3.3-3.24C18.64 3.55 15.82 2.2 12 2.2 5.73 2.2.6 7.35.6 13.62c0 6.27 5.13 11.42 11.4 11.42 6.58 0 10.93-4.62 10.93-11.13 0-.75-.08-1.32-.18-1.92Z" />
        </svg>
      </div>
    );
  }
